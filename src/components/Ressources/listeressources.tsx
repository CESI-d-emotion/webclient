    ...
    return (
        <>
            <section className="liste double">
                ...
                <p className="container modif">Recherche parmi les {ressourcesliste.length} Ressources présentes sur le site.</p>
                ...
                <div className="container carte-asso-ress carte-ress">
                    <div className="row">
                        {ressourcesliste
                            .filter((ressource) => {
                                return ressource.titre.toLowerCase().includes(filtreRess.toLowerCase());
                            })
                            .map((ressource) =>
                            (
                                <>
                                            ...
                                            <div className="card-body carte-body">
                                                ...
                                                <p className="card-info">
                                                    {ressource.createdAt  == ressource.updatedAt &&
                                                        <time dateTime={ressource.createdAt} className='date'>
                                                            Publiée le 
                                                            {format(parseISO(ressource.createdAt), ' EEEE d MMM yyyy à HH:mm ', {locale:fr})}
                                                        </time>
                                                    }
                                                    {ressource.createdAt  < ressource.updatedAt &&
                                                        <time dateTime={ressource.updatedAt} className='date'>
                                                            Mise à jour le 
                                                            {format(parseISO(ressource.updatedAt), ' EEEE d MMM yyyy à HH:mm ', {locale:fr})}
                                                        </time>
                                                    }  
                                                    par                                                    
